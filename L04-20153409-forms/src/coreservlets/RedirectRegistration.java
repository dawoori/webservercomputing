...
public class RedirectRegistration extends HttpServlet {
	...
	out.println("First Name: <INPUT TYPE=\"TEXT\" NAME=\"firstname\"VALUE=\"" + request.getParameter("firstname")
		+ "\"><BR>");
	...
	out.println("Email address:  <INPUT TYPE=\"TEXT\" NAME=\"emailaddress\" VALUE=\""
		+ request.getParameter("emailaddress") + "\"><BR>");
